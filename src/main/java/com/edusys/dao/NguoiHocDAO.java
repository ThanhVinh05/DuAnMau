...
public class NguoiHocDAO extends EduSysDAO<NguoiHoc, String> {
    ...
    public void insert(NguoiHoc entity) {
        JdbcHelper.update(INSERT_SQL, entity.getMaNH(),entity.getHoTen(),entity.getGioiTinh(),entity.getNgaySinh(),entity.getDienThoai(),entity.getEmail(),entity.getGhiChu(),entity.getMaNV(),entity.getNgayDK());
    }
    ...
    public void update(NguoiHoc entity) {
        JdbcHelper.update(UPDATE_SQL, entity.getHoTen(),entity.getGioiTinh(),entity.getNgaySinh(),entity.getDienThoai(),entity.getEmail(),entity.getGhiChu(),entity.getMaNV(),entity.getNgayDK(),entity.getMaNH());
    }
